...
- ASCII art header of my name generated using [Text to ASCII Art Generator (TAAG)](https://patorjk.com/software/taag/#p=display&f=Small+Slant&t=Tomas+Ordonez+Gonzalez&x=none&v=4&h=4&w=80&we=false).
